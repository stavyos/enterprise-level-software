...
- **Dedicated pgAdmin Instances**: Added `pgadmin-dev` (Port 5050) and `pgadmin-prd` (Port 5051) to `docker-compose.yaml`.
- **Pre-configured Access**: Documented connection steps for both environments using internal Docker networking.
