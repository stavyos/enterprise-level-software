...
- **Environment Isolation**: Strictly separates Parquet data into `data/dev` and `data/prod` directories on the host.

## Verification Results
- **Success Case**: Verified full intraday runs for `AAPL.US`, `MSFT.US`, `TSLA.US`, `NVDA.US`, `GOOGL.US`, and `META.US` (959-960 rows each).
