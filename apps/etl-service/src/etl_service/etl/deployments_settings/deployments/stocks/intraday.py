...
class DeploymentIntraday(AbstractDeploymentSettings):
    """Deployment settings for the INTRADAY ETL flow."""

    def __init__(self) -> None:
        """Initializes the DeploymentIntraday with the corresponding PrefectDeployment."""
        super().__init__(deployment=PrefectDeployment.INTRADAY)
