...
class DeploymentTickers(AbstractDeploymentSettings):
    """Deployment settings for the Tickers ETL flow."""

    def __init__(self) -> None:
        """Initializes the DeploymentTickers with the corresponding PrefectDeployment."""
        super().__init__(deployment=PrefectDeployment.TICKERS)
