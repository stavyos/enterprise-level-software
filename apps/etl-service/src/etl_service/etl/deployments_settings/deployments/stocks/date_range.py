...
class DeploymentDateRange(AbstractDeploymentSettings):
    """Deployment settings for the DATE RANGE ETL flow."""

    def __init__(self) -> None:
        """Initializes the DeploymentDateRange with the corresponding PrefectDeployment."""
        super().__init__(deployment=PrefectDeployment.MAIN_DATE_RANGE)
