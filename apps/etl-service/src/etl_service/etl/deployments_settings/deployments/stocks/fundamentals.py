...
class DeploymentFundamentals(AbstractDeploymentSettings):
    """Deployment settings for the Fundamentals ETL flow."""

    def __init__(self) -> None:
        """Initializes the DeploymentFundamentals with the corresponding PrefectDeployment."""
        super().__init__(deployment=PrefectDeployment.FUNDAMENTALS)
