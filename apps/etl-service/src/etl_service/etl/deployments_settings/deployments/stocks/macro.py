...
class DeploymentMacro(AbstractDeploymentSettings):
    """Deployment settings for the Macro Indicators ETL flow."""

    def __init__(self) -> None:
        super().__init__(deployment=PrefectDeployment.MACRO_INDICATORS)
