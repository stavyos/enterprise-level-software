...
class DeploymentNews(AbstractDeploymentSettings):
    """Deployment settings for the Market News ETL flow."""

    def __init__(self) -> None:
        super().__init__(deployment=PrefectDeployment.MARKET_NEWS)
